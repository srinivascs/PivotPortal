...
public class ProofsWorkFlow extends Page{

	public ProofsWorkFlow(WebDriver driver, Log log) throws InvalidFormatException, IOException {
		super(driver, log);
	}	
	@Override
	protected void load() {}
	...
	public boolean ProofsWorkFlowfunctionality(String Testname) throws Exception {
